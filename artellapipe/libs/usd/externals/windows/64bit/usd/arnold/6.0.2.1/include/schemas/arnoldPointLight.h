...
//
#ifndef USDARNOLD_GENERATED_ARNOLDPOINTLIGHT_H
#define USDARNOLD_GENERATED_ARNOLDPOINTLIGHT_H

/// \file usdArnold/arnoldPointLight.h
...
/// \class UsdArnoldPointLight
///
///
class UsdArnoldPointLight : public UsdArnoldLight
{
public:
    ...
    /// Construct a UsdArnoldPointLight on UsdPrim \p prim .
    /// Equivalent to UsdArnoldPointLight::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdArnoldPointLight(const UsdPrim& prim=UsdPrim())
        : UsdArnoldLight(prim)
    {
    }

    /// Construct a UsdArnoldPointLight on the prim held by \p schemaObj .
    /// Should be preferred over UsdArnoldPointLight(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdArnoldPointLight(const UsdSchemaBase& schemaObj)
    ...
    /// Return a UsdArnoldPointLight holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdArnoldPointLight(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDARNOLD_API
    static UsdArnoldPointLight
