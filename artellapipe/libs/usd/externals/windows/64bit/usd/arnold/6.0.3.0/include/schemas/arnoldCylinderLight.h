...
//
#ifndef USDARNOLD_GENERATED_ARNOLDCYLINDERLIGHT_H
#define USDARNOLD_GENERATED_ARNOLDCYLINDERLIGHT_H

/// \file usdArnold/arnoldCylinderLight.h
...
/// \class UsdArnoldCylinderLight
///
///
class UsdArnoldCylinderLight : public UsdArnoldLight
{
public:
    ...
    /// Construct a UsdArnoldCylinderLight on UsdPrim \p prim .
    /// Equivalent to UsdArnoldCylinderLight::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdArnoldCylinderLight(const UsdPrim& prim=UsdPrim())
        : UsdArnoldLight(prim)
    {
    }

    /// Construct a UsdArnoldCylinderLight on the prim held by \p schemaObj .
    /// Should be preferred over UsdArnoldCylinderLight(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdArnoldCylinderLight(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDARNOLD_API
    virtual ~UsdArnoldCylinderLight();
    ...
    /// Return a UsdArnoldCylinderLight holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdArnoldCylinderLight(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDARNOLD_API
    static UsdArnoldCylinderLight
