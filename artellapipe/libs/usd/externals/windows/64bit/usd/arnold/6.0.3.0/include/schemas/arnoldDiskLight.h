...
//
#ifndef USDARNOLD_GENERATED_ARNOLDDISKLIGHT_H
#define USDARNOLD_GENERATED_ARNOLDDISKLIGHT_H

/// \file usdArnold/arnoldDiskLight.h
...
/// \class UsdArnoldDiskLight
///
///
class UsdArnoldDiskLight : public UsdArnoldLight
{
public:
    ...
    /// Construct a UsdArnoldDiskLight on UsdPrim \p prim .
    /// Equivalent to UsdArnoldDiskLight::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdArnoldDiskLight(const UsdPrim& prim=UsdPrim())
        : UsdArnoldLight(prim)
    {
    }

    /// Construct a UsdArnoldDiskLight on the prim held by \p schemaObj .
    /// Should be preferred over UsdArnoldDiskLight(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdArnoldDiskLight(const UsdSchemaBase& schemaObj)
    ...
    /// Return a UsdArnoldDiskLight holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdArnoldDiskLight(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDARNOLD_API
    static UsdArnoldDiskLight
...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `vector3f[] direction` |
    /// | C++ Type | VtArray<GfVec3f> |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Vector3fArray |
    USDARNOLD_API
